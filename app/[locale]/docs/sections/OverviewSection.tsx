      ...
      <div style={{ fontSize: 11, color: 'var(--cp-text-dim)', lineHeight: 2.4 }}>
        <div style={{ marginBottom: 8 }}>
          ...
          <span style={{ paddingLeft: 16, display: 'inline-block' }}>
            Download <a href="https://zodl.org/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--cp-cyan)', textDecoration: 'underline' }}>ZODL</a> (mobile), <a href="https://vizor.cash" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--cp-cyan)', textDecoration: 'underline' }}>Vizor</a> (desktop), <a href="https://hhanh00.github.io/zkool2/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--cp-cyan)', textDecoration: 'underline' }}>zkool</a> (desktop &amp; mobile), or <a href="https://www.npmjs.com/package/@cipherpay/zipher-cli" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--cp-cyan)', textDecoration: 'underline' }}>Zipher CLI</a> (terminal / AI agents).
